...
/**
 * Base class that represents a query for the 'gametypes' table.
 *
 *
 *
 * @method     ChildGametypesQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildGametypesQuery orderByCode($order = Criteria::ASC) Order by the code column
 * @method     ChildGametypesQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildGametypesQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method     ChildGametypesQuery groupById() Group by the id column
 * @method     ChildGametypesQuery groupByCode() Group by the code column
 * @method     ChildGametypesQuery groupByName() Group by the name column
 * @method     ChildGametypesQuery groupByDescription() Group by the description column
 *
 * @method     ChildGametypesQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method     ChildGametypesQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method     ChildGametypesQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildGametypesQuery leftJoinWith($relation) Adds a LEFT JOIN clause and with to the query
 ...
 *
 * @method     ChildGametypes requireOneById(int $id) Return the first ChildGametypes filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGametypes requireOneByCode(int $code) Return the first ChildGametypes filtered by the code column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGametypes requireOneByName(string $name) Return the first ChildGametypes filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
...
abstract class GametypesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\GametypesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Gametypes', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildGametypesQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildGametypesQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildGametypesQuery) {
            return $criteria;
        }
        $query = new ChildGametypesQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildGametypes|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = GametypesTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key)))) {
     ...
     *
     * @return ChildGametypes A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        $sql = 'SELECT id, code, name, description FROM gametypes WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildGametypes $obj */
            $obj = new ChildGametypes();
            $obj->hydrate($row);
            GametypesTableMap::addInstanceToPool($obj, null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(GametypesTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(GametypesTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByCode($code = null, $comparison = null)
    {
        if (is_array($code)) {
            $useMinMax = false;
            if (isset($code['min'])) {
                $this->addUsingAlias(GametypesTableMap::COL_CODE, $code['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($code['max'])) {
                $this->addUsingAlias(GametypesTableMap::COL_CODE, $code['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_CODE, $code, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GametypesTableMap::COL_DESCRIPTION, $description, $comparison);
    }

    /**
     * Exclude object from result
     *
     * @param   ChildGametypes $gametypes Object to remove from the list of results
     *
     * @return $this|ChildGametypesQuery The current query, for fluid interface
     */
    public function prune($gametypes = null)
    {
        if ($gametypes) {
            $this->addUsingAlias(GametypesTableMap::COL_ID, $gametypes->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            GametypesTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(GametypesTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            GametypesTableMap::removeInstanceFromPool($criteria);
